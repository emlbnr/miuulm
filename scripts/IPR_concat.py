...
path = "/Users/emelbiner/PycharmProjects/miuulm/resource/Genome/interproscan/*.tsv"
out_file = "/Users/emelbiner/PycharmProjects/miuulm/data/ipr_concat.csv"
...
for key, value in sp_dic.items():
    ...
    dic_ann[key]["sp"] = key
    dic_ann[key].to_csv(f"/Users/emelbiner/PycharmProjects/miuulm/data/{key}.csv", sep="\t", index=False)
